...
<section class="sheet" style="align-items:center;text-align:center;justify-content:center">
    ...
    <div style="margin-top:auto;width:100%;display:flex;align-items:center;justify-content:space-between"><img class="brand" src="{{ asset('brand/logo.png') }}" alt="Gatezo"><span class="hint">Free entry pass · no app needed</span></div>
